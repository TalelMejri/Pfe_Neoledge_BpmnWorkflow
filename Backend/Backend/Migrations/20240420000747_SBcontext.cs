...
{
    /// <inheritdoc />
    public partial class SBcontext : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateHistoryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Diagrammes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Diagrammes_DateHistories_DateHistoryId",
                        column: x => x.DateHistoryId,
                        principalTable: "DateHistories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Diagrammes_DateHistoryId",
                table: "Diagrammes",
                column: "DateHistoryId",
                unique: true);
